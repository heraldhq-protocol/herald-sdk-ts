...
* seal Telegram/SMS channel data to gateway key, not user wallet ([49c3384](https://github.com/heraldhq-protocol/herald-sdk-ts/commit/49c3384bc5cff1506212b52f616fc23d47fc126e))
...
* **getStatus:** map delivery_channel to deliveryChannel in status response ([61d6102](https://github.com/heraldhq-protocol/herald-sdk-ts/commit/61d61026f60ef867e48bc30acf0108fdaf9ce3da))
...
* implement full gateway API surface in SDK client ([5aced16](https://github.com/heraldhq-protocol/herald-sdk-ts/commit/5aced1636885a86741875e32f6e383d91485ffb6))
* sync SDK client types and methods with notification gateway API ([da563ff](https://github.com/heraldhq-protocol/herald-sdk-ts/commit/da563ff70bd822c38b51a5eefb46560a7370aec0))
...
* add encryptEmailForGateway and encrypt*ForGateway functions for direct X25519 enclave mode ([198eb9c](https://github.com/heraldhq-protocol/herald-sdk-ts/commit/198eb9c33f96bfac15b956234b7752b7695eac22))
