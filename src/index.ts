...
export {
  ...
  MAX_NOTIFICATION_KEY_ROTATIONS,
} from "./constants.js";
...
// ── Notification Keys  ──────────────────────────────────
export { NotificationKeyClient } from "./notification-keys/index.js";
export {
  deriveX25519Keypair,
  sealX25519PubkeyForEnclave,
  decryptNotification as decryptNotificationPayload,
  decryptNotificationBody,
  zeroBytes,
} from "./notification-keys/index.js";
